...
/*   Updated: 2020/02/19 20:30:29 by plam             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_printf("\tft : %d\n", ft_printf("%-*c%-*.4s%-*d%-2p%%%-*i%-.u%% %.0x%%%% %-X", 0, 'c', 0,"hello//>>><<<<", 14 ,450, &c,  8,d, e, 3250, 3250));
	printf("\tOG : %d\n", printf("%-*c%-*.4s%-*d%-2p%%%-*i%-.u%% %.0x%%%% %-X", 0, 'c', 0,"hello//>>><<<<", 14 ,450, &c,  8,d, e, 3250, 3250));
